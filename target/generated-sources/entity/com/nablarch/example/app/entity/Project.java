...
public class Project implements Serializable {
    ...
    @Column(name = "PROJECT_ID", precision = 32, nullable = false, unique = true)
     ...
     * @return 顧客ID
     */
    @Column(name = "CLIENT_ID", precision = 32, nullable = true, unique = false, insertable = false, updatable = false)
     ...
     * @return ユーザID
     */
    @Column(name = "USER_ID", precision = 32, nullable = true, unique = false, insertable = false, updatable = false)
     ...
     * @return 売上高
     */
    @Column(name = "SALES", precision = 32, nullable = true, unique = false)
     ...
     * @return 売上原価
     */
    @Column(name = "COST_OF_GOODS_SOLD", precision = 32, nullable = true, unique = false)
     ...
     * @return 販管費
     */
    @Column(name = "SGA", precision = 32, nullable = true, unique = false)
     ...
     * @return 本社配賦
     */
    @Column(name = "ALLOCATION_OF_CORP_EXPENSES", precision = 32, nullable = true, unique = false)
